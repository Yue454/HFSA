import torch
from dataset import get_data_transforms, VisADataset
...
def train(_class_):
    ...
    train_path = f'./VisA_pytorch/1cls/{_class_}/train'
    test_path = f'./VisA_pytorch/1cls/{_class_}'
    ckp_path = f'./checkpoints/wres50_{_class_}.pth'
    os.makedirs(os.path.dirname(ckp_path), exist_ok=True)

    # 训练数据加载：ImageFolder可以自动处理jpg/png，无需更改
...
if __name__ == '__main__':
    ...
    item_list = ['capsules', 'candle', 'cashew', 'chewinggum', 'fryum', 'macaroni1', 'macaroni2', 'pcb1', 'pcb2',
